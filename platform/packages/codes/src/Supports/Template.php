...
namespace Botble\Code\Supports;
...
class Template
{
    ...
    public static function registerPageTemplate(array $templates = [])
    {
        ...
        config([
            'packages.codes.general.templates' => array_merge(
                config('packages.codes.general.templates'),
                $validTemplates
            ),
        ]);
    }
     ...
     * @since 16-09-2016
     */
    public static function getCodeTemplates(): array
    {
        return (array)config('packages.codes.general.templates', []);
    }
}
