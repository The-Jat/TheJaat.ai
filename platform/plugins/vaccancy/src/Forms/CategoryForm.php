...
namespace Botble\Vaccancy\Forms;
...
class CategoryForm extends FormAbstract
{
    ...
    {
        // get_categories is in helpers, TODO: better name for it
        $list = get_categories1(['condition' => []]);
        ...
        $categories = [0 => trans('plugins/vaccancy::categories.none')] + $categories;

        $this
            ->setupModel(new VaccancyCategory())
