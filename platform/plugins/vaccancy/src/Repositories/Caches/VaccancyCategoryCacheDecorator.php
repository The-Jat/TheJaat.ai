...
class VaccancyCategoryCacheDecorator extends CacheAbstractDecorator implements CategoryInterface
{
    ...
    public function getCategoryById(int|string|null $id): ?VaccancyCategory
    {
