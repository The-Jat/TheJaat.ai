...
namespace Botble\Shortener\Repositories\Interfaces;
...
interface ShortenerInterface extends RepositoryInterface
{
    ...
    // public function getRelatedCategoryIds(Shortener|int|string $model): array;
    ...
    // public function getSingleShortedField(int $id);
}
