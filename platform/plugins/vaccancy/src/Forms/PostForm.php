...
use Botble\Vaccancy\Forms\Fields\CategoryMultiField;
    ...
    public function buildForm(): void
    {
        ...
        $this
            ...
            ->add('categories[]', 'categoryMulti', [
                'label' => trans('plugins/vaccancy::posts.form.categories'),
                'label_attr' => ['class' => 'control-label required'],
                'choices' => get_categories_with_children1(),
            ...
            ->add('tag', 'tags', [
                ...
                'attr' => [
                    ...
                    'data-url' => route('vaccancy_tags.all'),
                ],
            ])
