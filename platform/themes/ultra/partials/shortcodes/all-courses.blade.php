        ...
        <div class="sidebar-widget loop-grid">
            ...
            <div class="row">
                ...
                @foreach ($coursesPosts as $post)
                    @if($post->id === 13 || $post->parent_id !== 0 ){{-- skip the course landing page becuse its id is 13 --}}
                        @continue
                    @endif 
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-30">
                        {!! Theme::partial('components.post-card-1-block-all-courses', ['post' => $post, 'showDescription' => false]) !!}
                    </div>
                @endforeach
                <div class="col-12">
