<div class="entry-header single-header-default entry-header-1 mb-30">
    ...
    @endif
    <h1 class="post-title">
        <a href="{{ get_external_link($post) }}" {{ is_external_link_vaccancy($post) ? 'target="_blank"' : '' }}>{{ $post->name }}</a>
    </h1>
    ...
    <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
        ...
        <span class="time-reading has-dot">{{ get_time_to_read_vaccancy_post($post) }} {{ __('mins read') }}</span>
