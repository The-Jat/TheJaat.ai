...
use Botble\Shortener\Services\BlogService;
...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        $this->app['events']->listen(RouteMatched::class, function () {
            if (function_exists('admin_bar')) {
                admin_bar()->registerLink(trans('plugins/shortener::base.admin_bar_name'), route('shortener.create'), 'add-new', 'shortener.create');
            }
        });
        ...
        if (function_exists('add_shortcode')) {
            add_shortcode(
                'shortener-posts',
                trans('plugins/shortener::base.short_code_name'),
                trans('plugins/shortener::base.short_code_description'),
                [$this, 'renderBlogPosts']
            );
            shortcode()->setAdminConfig('shortener-posts', function ($attributes, $content) {
                return view('plugins/shortener::partials.posts-short-code-admin-config', compact('attributes', 'content'))
                    ->render();
            });
        }
    ...
    public function addThemeOptions()
    {
        ...
        //     ->setSection([
        //         'title' => 'Shortener',
        //         'desc' => 'Theme options for Shortener',
        //         'id' => 'opt-text-subsection-shortener',
        //         'subsection' => true,
        //         'icon' => 'fa fa-edit',
        //         'fields' => [
        //             [
        //                 'id' => 'blog_page_id',
        //                 'type' => 'customSelect',
        //                 'label' => trans('plugins/shortener::base.blog_page_id'),
        //                 'attributes' => [
        //                     'name' => 'blog_page_id',
        //                     'list' => ['' => trans('plugins/shortener::base.select')] + $pages,
        //                     'value' => '',
        //                     'options' => [
        //                         'class' => 'form-control',
        //                     ],
        ...
        //                 'type' => 'number',
        //                 'label' => trans('plugins/shortener::base.number_posts_per_page_in_category'),
        //                 'attributes' => [
        ...
        //                 'type' => 'number',
        //                 'label' => trans('plugins/shortener::base.number_posts_per_page_in_tag'),
        //                 'attributes' => [
    ...
    public function registerMenuOptions(): void
    {
        ...
        //     Menu::registerMenuOptions(Category::class, trans('plugins/shortener::categories.menu'));
        // }

        // if (Auth::user()->hasPermission('tags.index')) {
        //     Menu::registerMenuOptions(Tag::class, trans('plugins/shortener::tags.menu'));
        // }
    }
    ...
    public function registerDashboardWidgets(array $widgets, Collection $widgetSettings): array
    {
        ...
        Assets::addScriptsDirectly(['/vendor/core/plugins/shortener/js/shortener.js']);

        return (new DashboardWidgetInstance())
            ->setPermission('posts.index')
            ->setKey('widget_posts_recent')
            ->setTitle(trans('plugins/shortener::posts.widget_posts_recent'))
            ->setIcon('fas fa-edit')
            ->setColor('#f3c200')
    ...
    public function renderBlogPosts(Shortcode $shortcode): array|string
    {
        ...
        $view = 'plugins/shortener::themes.templates.posts';
    ...
    public function renderBlogPage(?string $content, Page $page): ?string
    {
        if ($page->id == theme_option('blog_page_id', setting('blog_page_id'))) {
            $view = 'plugins/shortener::themes.loop';
    ...
    {
        if ($page->id == theme_option('blog_page_id', setting('blog_page_id'))) {
            $subTitle = Html::tag('span', trans('plugins/shortener::base.blog_page'), ['class' => 'additional-page-name'])
                ->toHtml();
...
/**
    ...
    {
        return $data . view('plugins/shortener::settings')->render();
    }
}
