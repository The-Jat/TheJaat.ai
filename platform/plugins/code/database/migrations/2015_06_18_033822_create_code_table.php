...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('code_posts', function (Blueprint $table) {
            ...
            $table->string('difficulty', 60)->default('easy');
            $table->integer('order')->default(0);
            $table->tinyInteger('is_parent')->unsigned()->default(0);
            $table->timestamps();
        });

        Schema::create('code_post_tags', function (Blueprint $table) {
            $table->foreignId('tag_id')->index();
            $table->foreignId('post_id')->index();
        });

        Schema::create('code_post_categories', function (Blueprint $table) {
