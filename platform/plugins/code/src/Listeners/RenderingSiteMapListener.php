...
class RenderingSiteMapListener
{
    ...
    public function handle(RenderingSiteMapEvent $event): void
    {
        ...
        SiteMapManager::addSitemap(SiteMapManager::route('code-posts'), $postLastUpdated);
        ...
        SiteMapManager::addSitemap(SiteMapManager::route('code-categories'), $categoryLastUpdated);
        ...
        SiteMapManager::addSitemap(SiteMapManager::route('code-tags'), $tagLastUpdated);
    }
}
