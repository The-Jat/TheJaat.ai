...
class HookServiceProvider extends ServiceProvider
{
    ...
    {
        // didn't find the way to check permisson for the member, here only permission is
        // checked for the auth user which is null, when the member do operations on blog post.
        // So, i commented that line and thus it does not check for the permission shown to every one.
